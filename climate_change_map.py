...
# Step B: Backup calculation using the first 30 years available for each country
baseline_backup = (
    yearly
    .groupby("Country")
    .head(BACKUP_YEARS)
...
fig = px.choropleth(
    ...
    title=(
        "<b>Climate Through Time: Temperature Anomalies by Country</b>"
        "<br><sup>"
